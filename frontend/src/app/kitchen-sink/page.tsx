      ...
      <main className="mx-auto max-w-2xl space-y-10 px-4 pb-32 pt-6">
        ...
        <Section title="Bodygraph">
          <div className="surface space-y-3 p-4">
            ...
            />
            <div className="h-80">
              <Bodygraph view={view} colors={colors} onMuscleClick={setTapped} />
            </div>
          ...
          <div className="surface h-64 p-4">
            <BodygraphPair colors={colors} interactive={false} />
          </div>
        </Section>
        ...
        <Section title="Pickers">
          <div className="surface p-4">
            <RulerPicker value={weight} onChange={setWeight} min={30} max={200} step={0.5} unit="kg" label="Bodyweight" />
          </div>
          <div className="surface flex items-center justify-around p-4">
            ...
            <div>
              ...
              <WheelPicker
                options={Array.from({ length: 73 }, (_, i) => i + 13)}
                value={age}
                onChange={setAge}
                label="Age"
              />
        ...
        <Section title="Display">
          ...
          <div className="surface">
            <EmptyState
              ...
              pose="sad"
              action={<Button variant="chunky" size="cta">Create routine</Button>}
            />
          </div>
        </Section>
